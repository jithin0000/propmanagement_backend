...
def fake_property():
    ...
    for i in range(1, 10):
        ...
        r = requests.get(url="https://www.zipcodeapi.com/rest/fyJHJpNNIegU4Hr9eyh9wOIm3ItMcEBQDNGNMKYSdsO2FbJAmAt0aRqKPP0bMRlu/info.json/{}/degrees".format(al_zipcode[i]))
        data = r.json()
